...
```
```{r}
# In the year column, we can see that we have data from 1871 to 2013, which we do not need. Grab data from 1985 onward (salary data to be used later also begins # from 1985)
